  ...
  return (
    <div className="min-h-screen employee-services-page">
      ...
      <main>
        ...
        {/* Loading State */}
        {isLoading && (
          <section className="relative pt-36 md:pt-44 pb-20" style={{ backgroundColor: '#f7f8f9' }}>
        ...
        {!isLoading && !error && infoServices.length > 0 && (
          <section className="relative pt-36 md:pt-44 pb-12 overflow-hidden" style={{ backgroundColor: '#f7f8f9' }}>
