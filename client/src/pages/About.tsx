          ...
          <div className="container-custom text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {[
                ...
                { image: cardHarith, nameKey: "about.deputy.mohammed", titleKey: "about.deputy.mohammed.title", objPos: 'center 85%' },
                ...
                { image: cardAli, nameKey: "about.deputy.ali", titleKey: "about.deputy.ali.title", objPos: 'center 85%' },
              ].map((leader, idx) => (
                <motion.div
                  key={idx}
                    ...
                    <div className="relative aspect-square overflow-hidden rounded-[2.5rem] mb-8 bg-gray-50">
                      {leader.useObjectTop ? (
                        ...
                        <img
                          ...
                          style={{ bottom: '-5%', height: '240%', objectFit: 'cover', objectPosition: leader.objPos || 'center bottom' }}
                        />
                      )}
                    </div>
