    ...
    <div className="min-h-screen overflow-x-hidden" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10 text-center text-white px-4 py-32 xl:py-44 2xl:py-56">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >
              <h1 className={`text-4xl md:text-5xl xl:text-6xl 2xl:text-7xl font-bold mb-4 ${fontClass}`}>
                {language === 'ar' ? 'قصة التحول الصحي في نجران' : 'Najran Health Transformation Story'}
              </h1>
              <p className={`text-white/70 text-lg xl:text-xl 2xl:text-2xl ${fontClass}`}>
                {language === 'ar'
              ...
              >
                <div className="flex flex-col items-start gap-4">
                  ...
                  <img
                    ...
                    className="h-24 sm:h-32 w-auto object-contain mb-1 dark:brightness-0 dark:invert"
                  />
                  <p className={`text-[#2BAAE2] dark:text-white text-[10px] ${fontClass} -translate-x-2 sm:translate-x-3`} style={{ marginTop: '-22px' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-10">
              <div className="md:col-start-1 md:col-end-2 lg:col-start-2 lg:col-end-3">
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <div className="bg-white rounded-[3.5rem] p-8 shadow-sm border border-gray-100 transition-all duration-[400ms] hover:-translate-y-3 hover:shadow-[0_20px_40px_rgba(43,170,226,0.2)] hover:border-[#2BAAE2]">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-3 xs:gap-4 sm:gap-6">
              {[
                ...
                <motion.div
                  ...
                  className="group bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm text-center relative hover:-translate-y-3 hover:shadow-[0_20px_40px_rgba(43,170,226,0.2)] hover:border-[#2BAAE2] transition-all duration-[400ms]"
                >
                  <CardStar size="md" />
        ...
        <section className="relative py-16 overflow-hidden" style={{ backgroundColor: '#f7f8f9' }}>
          ...
          <div className="container-custom relative z-10">
            ...
            >
              <div className="inline-flex items-center justify-center w-16 h-16 bg-[#2BAAE2]/10 border border-[#2BAAE2]/20 rounded-3xl mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {[
                ...
                <motion.div
                  ...
                  className="group bg-white rounded-xl border border-gray-100 shadow-sm hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(43,170,226,0.15)] hover:border-[#2BAAE2] transition-all duration-[400ms] p-4"
