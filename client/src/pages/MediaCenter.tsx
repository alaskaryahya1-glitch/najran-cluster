...
const mediaItems = [
  ...
  {
    id: 5,
    titleAr: 'شعار تجمع نجران الصحي',
    titleEn: 'Najran Health Cluster Logo',
    subAr: 'أفقي - ملون',
    subEn: 'Horizontal - Color',
    darkBg: false,
    href: '/media-center',
    thumb: '/logos/najran-horizontal-color.png',
  },
  {
    id: 6,
    titleAr: 'شعار تجمع نجران الصحي',
    ...
    darkBg: false,
    href: '/media-center',
    thumb: '/logos/najran-vertical-color.png',
  },
  {
    id: 7,
    titleAr: 'شعار تجمع نجران الصحي',
    ...
    darkBg: true,
    href: '/media-center',
    thumb: '/logos/najran-horizontal-white.png',
  },
  {
    id: 8,
    titleAr: 'شعار تجمع نجران الصحي',
    ...
    darkBg: true,
    href: '/media-center',
    thumb: '/logos/najran-vertical-white.png',
  },
  {
    id: 9,
    titleAr: 'شعار تجمع نجران الصحي',
    ...
    darkBg: true,
    href: '/media-center',
    thumb: '/logos/najran-icon-white.png',
  },
];
          ...
          <div className="container-custom relative z-20">
            <motion.div className="text-center mb-8">
              <div className="w-20 h-20 xl:w-28 xl:h-28 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <Library className="w-10 h-10 xl:w-14 xl:h-14 text-[#2BAAE2]" />
              </div>
