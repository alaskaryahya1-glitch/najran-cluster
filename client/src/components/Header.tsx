...
export function Header() {
  ...
  const sidebarNavItems = [
    ...
    { label: t("nav.gates Journey"), href: "https://nhcgate3.info/", icon: ExternalLink, external: true },
    { label: t("nav.care Model"), href: "/care-model", icon: Heart },
    { label: t("nav.employee Services"), href: "/employee-services", icon: Users },
    { label: t("nav.eServices"), href: "/e-services", icon: Globe },
    { label: t("nav.Maternity Hospital"), href: "https://mch.nhc.moh.gov.sa/services", icon: ExternalLink, external: true },
