...
export default function News() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <main>
        {/* Hero */}
        <section className="hero-section relative py-32 xl:py-44 2xl:py-56 overflow-hidden w-full" style={{ backgroundColor: '#004070', minHeight: '65vh' }}>
          ...
          <div className="container-custom relative z-10">
            <motion.div className="text-center">
              <div className="inline-flex items-center justify-center w-20 h-20 xl:w-28 xl:h-28 rounded-2xl bg-white/20 mb-6">
                <Newspaper className="w-10 h-10 xl:w-14 xl:h-14 text-[#2BAAE2] brand-icon" />
              </div>
              <h1 className={`text-2xl xs:text-3xl sm:text-4xl md:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-white mb-4 ${fontClass}`}>
                {language === 'ar' ? 'أخبار التجمع' : 'Cluster News'}
              </h1>
              <p className={`text-white/80 text-lg xl:text-xl 2xl:text-2xl ${fontClass}`}>
