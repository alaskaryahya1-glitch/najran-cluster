    ...
    <div className="min-h-screen flex flex-col overflow-x-hidden relative">
      ...
      <main className="flex-1 relative z-10">
        ...
        <section ref={heroRef} className="relative h-[100svh] min-h-[500px] sm:min-h-[600px]">
          ...
          {/* Hero Content */}
          <motion.div
            className="container-custom relative h-full flex flex-col justify-center items-center text-center px-4 pt-64 sm:pt-72 md:pt-72 lg:pt-80 pb-8 md:pb-40 z-10"
