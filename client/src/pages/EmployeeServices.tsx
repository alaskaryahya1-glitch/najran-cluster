...
export default function EmployeeServices() {
  ...
  return (
    <div className="min-h-screen employee-services-page overflow-x-hidden" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      <Header />
        ...
        <section className="hero-section relative py-32 xl:py-44 2xl:py-56 overflow-hidden" style={{ backgroundColor: '#004070', minHeight: '65vh' }}>
          ...
          <div className="container-custom relative z-20">
            ...
            >
              ...
              <p className={`text-white/80 ${fontClass} text-base sm:text-lg md:text-xl xl:text-xl 2xl:text-2xl`}>
