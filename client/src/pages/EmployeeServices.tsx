              ...
              >
                {hasLogo && logoSrc ? (
                  <img 
                    ...
                    style={{
                      filter: isHovered
                        ? "brightness(0.85) sepia(0.35) saturate(2) hue-rotate(110deg) drop-shadow(0 2px 6px rgba(0,77,58,0.2))"
                        : "brightness(0.8) sepia(0.35) saturate(2) hue-rotate(165deg) drop-shadow(0 1px 4px rgba(43,170,226,0.2))"
                    }}
                  />
                ) : (
